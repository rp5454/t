...
const DeleteApplication = () => {
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      {application && (
        <>
          <p>Are you sure you want to delete the application for <strong>{application.name}</strong>?</p>
          <button style={{ background: "red", color: "white", marginRight: "10px" }} onClick={handleDelete}>
            Yes, Delete
          </button>
